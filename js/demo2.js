    ...
    navigate(direction) {
        ...
        gsap
            ...
            .to(currentItem, {
                ...
                onComplete: () => gsap.set(currentItem, {
                    opacity: 0
                })
            })
            .to(currentInner, {
...
// navigation controls
const navigation = {
    'next': document.querySelectorAll('.slider-nav__item--next'),
    'prev': document.querySelectorAll('.slider-nav__item--prev'),
...
// Loop through each element in the NodeList and attach an event listener
navigation.next.forEach(element => {
    element.addEventListener('click', () => navigate('next'));
});

// Loop through each element in the NodeList and attach an event listener
navigation.prev.forEach(element => {
    element.addEventListener('click', () => navigate('prev'));
});
...
parcelRequire = (function (modules, cache, entry, globalName) {
    ...
    "QvaY": [function (require, module, exports) {
        ...
        var DOM = {
            splitcontent: {
                home: {
                    section: document.querySelector('.split__item--work'),
        ...
        .to('.slider-nav', {
            ...
            .to('.slider__item--current', {
                duration: 0.8,
                pointerEvents: 'none',
                ease: 'Power3.easeInOut'
            }, 'start')

            .to('.slider__column--left', {
                duration: 0.8,
                opacity: 0,
                ease: 'Power3.easeInOut'
            }, 'start')
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const assetsToPreload = [
                ...
                { url: './img/just_egg_bg.jpg', size: 352_821 },
                { url: './img/just_egg_fg.jpg', size: 245_096 },
                { url: './img/nurtalk_bg.jpg', size: 72_874 },
                { url: './img/nurtalk_fg.jpg', size: 24_398 },
                { url: './img/portfolio_v1_bg.jpg', size: 337_481 },
                { url: './img/portfolio_v1_fg.jpg', size: 71_233 },
                { url: './img/dual_bg.jpg', size: 298_454 },
                { url: './img/dual_fg.jpg', size: 1_493_906 },
                { url: './img/youtube_games_bg.jpg', size: 108_841 },
                { url: './img/youtube_games_fg.jpg', size: 364_037 }
