
{
    ...
    parcelRequire = (function (modules, cache, entry, globalName) {
        ...
        "TNS6": [function (require, module, exports) {
            ...
            document.querySelectorAll('.spotlight').forEach(link => new OpacityEffect(link));
        ...
        "QvaY": [function (require, module, exports) {
            ...
            const opacityValue = isMobileDevice() ? 0 : 0.2; // Adjust opacity values as needed
            ...
            var timeline = _gsap.gsap.timeline({
                ...
                .staggerTo(DOM.splitcontent.home.chars, timelineSettings.charsDuration, {
                    ease: 'Power3.easeIn',
                    y: '-100%',
                    opacity: 0
                ...
                .addLabel('switchtime').add(function () {
                    DOM.splitcontent.home.section.classList.toggle('split__item--current');
                    DOM.splitcontent.about.section.classList.toggle('split__item--current');
                })
                .set(DOM.splitcontent.about.chars, {
                    y: '100%'
                }, 'switchtime').set(DOM.splitcontent.about.picture, {
                    y: '30%',
                    rotation: -1,
                    opacity: 0
                }, 'switchtime') // Stagger the animation of the about section chars
                .staggerTo(DOM.splitcontent.about.chars, timelineSettings.charsDuration, {
                    ease: 'Power3.easeOut',
                    y: '0%'
                }, timelineSettings.staggerValue, 'switchtime+=0.2')
            ...
            .to('.mobile__extension', {
                ...
                .to(DOM.splitcontent.about.picture, {
                    ...
                    pointerEvents: 'all',
                    rotation: 0
                }, 'switchtime'); // Clicking the about and homepage links will toggle the content area, by playing and reversing the timeline
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const preloadAssets = (assets, callback) => {
                    ...
                    assets.forEach(asset => {
                        fetch(asset.url)
                            ...
                            .then(blob => {
                                loadedAssetsSize += asset.size || 0; // using our static size as that's what our final % is
                                loadedCount++;
                ...
                // size is uncompressed size in bytes, doesn't need to be 100% accurate only used
                const assetsToPreload = [
                    { url: './fonts/PPNeueMontreal-Regular.woff2', size: 48_172 },
                    ...
                    { url: './img/just_egg_cover.jpg', size: 372_557 },
                    { url: './img/just_egg_cover_bw.jpg', size: 207_825 },
                    { url: './img/youtube_games_cover.jpg', size: 93_760 },
                    { url: './img/youtube_games_cover_bw.jpg', size: 78_589 },
                    { url: './img/displacement.png', size: 26_269 },
                    { url: './img/portfolio_v1_cover.jpg', size: 77_029 }
    ...
    `;
        ...
        var addEvents = function (greatGrandparent) {
            ...
            greatGrandparent.addEventListener(evtIn, function (e) {
            ...
            greatGrandparent.addEventListener(evtOut, function (e) {
        ...
        if (userHover) {
            addEvents(opts.greatGrandparent); // Pass greatGrandparent to addEvents
        }
    ...
    new hoverEffect({
        ...
        greatGrandparent: document.querySelector('.selected__work--row'),
        intensity1: 0.1,
        intensity2: 0.1,
        angle2: Math.PI / 2,
        image1: './img/portfolio_v1_cover.jpg',
        image2: './img/portfolio_v1_cover.jpg',
        displacementImage: './img/displacement.png'
    });

    new hoverEffect({
        parent: document.querySelector('.inner-wrap2'), // Replace with the actual class or selector for your second div
        greatGrandparent: document.querySelector('.selected__work--row2'),
        intensity1: 0.1,
        intensity2: 0.1,
        angle2: Math.PI / 2,
        image1: './img/youtube_games_cover_bw.jpg',
        image2: './img/youtube_games_cover.jpg',
        displacementImage: './img/displacement.png'
    });


    new hoverEffect({
        parent: document.querySelector('.inner-wrap3'), // Replace with the actual class or selector for your second div
        greatGrandparent: document.querySelector('.selected__work--row3'),
        intensity1: 0.1,
        intensity2: 0.1,
        angle2: Math.PI / 2,
        image1: './img/just_egg_cover_bw.jpg',
        image2: './img/just_egg_cover.jpg',
        displacementImage: './img/displacement.png'
    });
